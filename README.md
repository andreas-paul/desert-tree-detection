...
### Initial Results
#### DeepForest
Below the initial results of using the DeepForest model to predict trees on satellite imagery. Note that DeepForest is created for drone imagery with much higher GSD compared to the satellite image. Hence, only few of the trees were predicted, namely those that show high structural detail compared to the surrounding specimen.
